...
namespace Xamalytics.Api.Filters
{
    /// <summary>
    /// Exception filters
    /// </summary>
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        {
            var exception = new ValidateModelStateDictionary(context.ModelState);
        ...
        {
            ServiceResult details = ServiceResult.Failed(ServiceError.CustomMessage(
                (context.Exception is NotFoundException exception
                ? exception.Message
                : ServiceError.NotFound.ToString()) ?? string.Empty));
